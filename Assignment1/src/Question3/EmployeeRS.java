...
class HourlySalaried extends Employee {
    ...
    public double earnings() {
        return getHourlySalary() * getTime();
    }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    for (int i = 0; i < 5; i++) {
                        if (Name[i].equals(sc)) {
                            System.out.print("Employee type \"Salaried, HourlySalaried,Commissioned\" : ");
                            ...
                            if (type.contains("HourlySalaried")) {
                                System.out.println("Enter New Name");
                                ref[i].setName(Name[i] = input.nextLine());
                                System.out.println("Enter New Phone");
                                ref[i].setPhone(phone[i] = input.nextLine());
